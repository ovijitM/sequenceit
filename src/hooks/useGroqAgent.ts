    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          image_url: { type: "string", description: "Public HTTP/HTTPS URL to project image" },
          category: {
            type: "string",
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          role: { type: "string" },
          bio: { type: "string" },
          image_url: { type: "string", description: "Public HTTP/HTTPS URL to team member photo" },
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          company: { type: "string" },
          content: { type: "string" },
          image_url: { type: "string", description: "Public HTTP/HTTPS URL to testimonial author photo" },
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          author: { type: "string" },
          category: { type: "string" },
          image_url: { type: "string", description: "Public HTTP/HTTPS URL to the blog post image (e.g., https://example.com/image.jpg)" },
          read_time: { type: "string" },
          is_featured: { type: ["boolean", "string"], description: "Whether this is a featured post (true/false)" },
          published: { type: ["boolean", "string"], description: "Whether to publish immediately (true/false)" },
        },
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          author: { type: "string" },
          category: { type: "string" },
          image_url: { type: "string", description: "Public HTTP/HTTPS URL to the blog post image" },
          read_time: { type: "string" },
          is_featured: { type: ["boolean", "string"], description: "Whether this is a featured post (true/false)" },
          published: { type: ["boolean", "string"], description: "Whether to publish (true/false)" },
        },
        required: ["id"],
      },
    },
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          location: { type: "string", description: "Work location: Remote, Hybrid, or On-site" },
          type: { type: "string", description: "Employment type: Full-time, Part-time, or Contract" },
          description: { type: "string" },
    ...
    function: {
      ...
      parameters: {
        ...
        properties: {
          ...
          image_url: { type: "string", description: "Public HTTP/HTTPS URL to case study image" },
          ...
          results: {
            ...
            items: {
              type: "object",
              properties: {
                metric: { type: "string", description: "Label for the result metric, e.g. 'Performance Increase'" },
                value: { type: "string", description: "Value of the metric, e.g. '40%'" },
                icon: { type: "string", description: "Icon name: TrendingUp, Users, Zap, or DollarSign" },
              },
              required: ["metric", "value", "icon"],
            },
          },
          published: { type: ["boolean", "string"], description: "Whether to publish immediately (true/false)" },
        },
